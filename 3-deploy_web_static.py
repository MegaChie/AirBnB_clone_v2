...
def do_deploy(archive_path):
    ...
    if not exists(archive_path):
        return False
    try:
        # Extract file name and base name (without extension) from the archive path
        ...
        # Remove the current symbolic link and create a new one pointing to the new release
